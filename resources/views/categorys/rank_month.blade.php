@extends('layouts.app')
@section('title','BĐS nổi bật theo tháng, truyện hay')
@section('content')
<div class="detail-rank pt-36" id="min-height">
    <div class="find-novel container">
        <div class="title">
            ...
            <a class="text-warning" href="/truyen-thang">BĐS nổi bật tháng</a>
        </div>
        <div class="title-tab mt-3">
            <ul class="nav nav-tabs tab-rank w-100">
                ...
                <li class="nav-item ">
                    <a class="nav-link nav-week text-center" data-toggle="tab" href="#">Theo Tuần</a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link  nav-month active text-center" data-toggle="tab" href="#month">Theo Tháng</a>
                </li>
            </ul>
        </div>
            ...
            <div class="tab-pane active" id="month">
                            ...
                            <div class="col-lg-4 ">
                                <div class="option-item mt-3 mt-lg-0 option-type" data-pick="list-type-pick">
                                    <div class="d-flex justify-content-between ">
                                        ...
                                        <div class="d-flex">
                                            <span class="mr-2 text-blue f-550">Chọn thể loại</span>
                                            <img src="/images/light/ic_filter_dropdown_inactive.svg" alt="Xuống" width="14px" height="20px" class="mt-2px dark"> 
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="tab-content mt-4 ">
                    <div class="list-hot-group">
                        ...
                        <p class="col-12 mb-3 text-noti-none d-none text-danger h5">
...
<script>
    $( document ).ready(function() {
        ...
        if(length==9||length==7||length==5||length==3) {
        ...
        $('.check-box-status').click(function(){
            ...
            if(status !=  $(this).attr("data-id")){
                ...
                var url = "/truyen-thang?status=" + status
                if(chapter > 0){
                    url = url + "&chapter=" + chapter;
                }
