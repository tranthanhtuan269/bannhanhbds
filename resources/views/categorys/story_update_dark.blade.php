...
@section('title','BĐS mới đăng bán, truyện hay')
@section('content')
<div class="find-novel container pt-36" id="min-height">
    <div class="title">
        ...
        <a class="text-warning" href="/truyen-moi-cap-nhat">BĐS mới đăng bán</a>
    </div>
    <div  style="position:relative;">
        ...
        <div class="list-type-pick px-4 py-2 d-none list-pick">
            <div class="row">
                @foreach ($cache_types as $val)
                <div class="col-lg-2 col-6 col-sm-4 col-md-3" id="type-{{$val->id}}">
                            ...
                            <div class="item-content pr-4 over-hidden">
                                ...
                                <div class="d-flex justify-content-between mt-3">
                                    ...
                                    <div class="star align-items-center d-flex ">
                                        ...
                                        @if ($data->full==1)
                                        <span class="ml-1 text-000-4 text-no-wrap">{{$data->number_last}} [Hết]</span>
                                        @else
...
<script>
    $( document ).ready(function() {
        $('.dropdown-menu-category .update-item').addClass('active')
        ...
        $('.check-box-status').click(function(){
            ...
            if(status !=  $(this).attr("data-id")){
                ...
                var url = "/truyen-moi-cap-nhat?status=" + status
                if(chapter > 0){
                    url = url + "&chapter=" + chapter;
                }
