    ...
    <div class="find-novel container">
        ...
        <div class="title-tab mt-3">
            <ul class="nav nav-tabs tab-rank w-100">
                ...
                <li class="nav-item ">
                    <a class="nav-link text-center nav-week" data-toggle="tab" href="#">Theo Tuần</a>
                </li>
                <li class="nav-item ">
            ...
            <div class="tab-pane active" id="all">
                ...
                <div class="tab-content mt-4 ">
                    <ul class="list-hot-group">
                        ...
                        <p class="col-12 text-noti-none d-none text-danger mb-3 h5">
    ...
    $( document ).ready(function() {
        ...
        $('.check-box-status').click(function(){
            ...
            if(status !=  $(this).attr("data-id")){
                ...
                var url = "/truyen-hot?status=" + status
                if(chapter > 0){
                    url = url + "&chapter=" + chapter;
                }
